    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Product p=d.getProductbyID(id);
                if("1".equals(request.getParameter("rmv"))&&"0".equals(num)){
                    cart.removeItem(id);
                }
            if("-1".equals(num)&&cart.getQuantityById(id)<=1){
                cart.removeItem(id);
            } else if("-1".equals(num)&&cart.getQuantityById(id)>1){
        ...
        request.setAttribute("cart", cart);
          request.setAttribute("tops", d.getRandP("4"));
