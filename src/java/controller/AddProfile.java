...
public class AddProfile extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(idraw.isEmpty()||phone.isEmpty()||addr.isEmpty()||graw.isEmpty()){
            request.setAttribute("err", "You must fill all the blank");
            request.getRequestDispatcher("addprofile.jsp").forward(request, response);
        }else{
        DAO da=new DAO();
        da.insertUD(Integer.parseInt(idraw), phone, addr, Integer.parseInt(graw));
