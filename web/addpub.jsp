<%-- 
    Document   : addpub
    Created on : 10-07-2023, 16:07:53
    Author     : Minh
--%>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" method="post" action="addpub">
            <div class="form-group">
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Publsher Name" name="name">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Describe" name="desc">
            </div>
