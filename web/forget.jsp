<%-- 
    Document   : forget
    Created on : 10-07-2023, 16:55:24
    Author     : Minh
--%>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" method="post" action="forget">
            <div class="form-group">
              <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" name="mail">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Username" name="un">
            </div>
              <div class="mt-20">${requestScope.er}</div>
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center">OK</button>
            </div>
          </form>
              <c:if test="${requestScope.ps!=null}"> <div class="mt-20">Your password is:${requestScope.ps}</c:if>
