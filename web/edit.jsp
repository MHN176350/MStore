<%-- 
    Document   : edit
    Created on : 01-07-2023, 00:59:20
    Author     : Minh
--%>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <h2 class="text-center">Product Editting</h2>
          <c:set value="${requestScope.p}" var="t"></c:set>
          <form class="text-left clearfix" method="post" action="edit">
               <div class="form-group">
                   <input type="hidden" class="form-control" id="exampleInputEmail1" value="${t.id}" name="id" readonlyname="id">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="exampleInputEmail1" value="${t.title}" name="title">
            </div>
            <div class="form-group">
                <select name ="pub" class="form-control">
                  <c:forEach items="${requestScope.pub}" var="p">
                      <option value="${p.id}" ${p.id == t.pid ? 'selected' : ''}>${p.name}
                  </c:forEach>
            </select>
            </div>
              <div class="form-group">
                  <input type="number" class="form-control" id="exampleInputEmail1" value="${t.price}" name="price">
            </div>
              <div class="form-group">
              <input type="text" class="form-control" id="exampleInputEmail1" value="${t.icon}" name="icon">
            </div>
              <div class="form-group">
              <input type="text" class="form-control" id="exampleInputEmail1" value="${t.describe}" name="desc">
            </div>
              <div class="form-group">
              <input type="text" class="form-control" id="exampleInputEmail1" value="${t.genre}" name="gen">
            </div>
