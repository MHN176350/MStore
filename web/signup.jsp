<%-- 
    Document   : signup
    Created on : 13-06-2023, 10:34:04
    Author     : Minh
--%>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="signup" method="post">
              <div class="form-group">
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Username" name="uname">
            </div>
            <div class="form-group">
          ...
          <p><a href="forget.jsp"> Forgot your password?</a></p>
        </div>
      </div>
    </div>
  </div>
