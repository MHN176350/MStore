<%-- 
    Document   : checkout
    Created on : 03-07-2023, 14:16:21
    Author     : Minh
--%>
...
<html>
    <head>
        ...
        <style>@import url('https://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900&display=swap');
html,body {
...
<div class="thankyou-page">
    ...
    <div class="_body">
        <div class="_box">
            <h2>
                <strong>Please check your email</strong> for product activated code!
            </h2>
            <p>
    ...
    <div class="_footer">
        ...
        <a class="btn" href="index">Back to homepage</a>
    </div>
</div>
    </body>
</html>
